...
func TestHostsListHandler(t *testing.T) {
	...
	sapSystemMapFoo := map[string]interface{}{
		"sys1": map[string]interface{}{
			"sid": "sys1",
		},
	}
	sapSystemMapBar := map[string]interface{}{
		"sys2": map[string]interface{}{
			"sid": "sys2",
		},
	}
	sapSystemMapBuzz := map[string]interface{}{
	...
	sapsystemPathFoo := "trento/v0/hosts/foo/sapsystems/"
	consulInst.On("WaitLock", sapsystemPathFoo).Return(nil)
	kv.On("ListMap", sapsystemPathFoo, sapsystemPathFoo).Return(sapSystemMapFoo, nil)
	sapsystemPathBar := "trento/v0/hosts/bar/sapsystems/"
	consulInst.On("WaitLock", sapsystemPathBar).Return(nil)
	kv.On("ListMap", sapsystemPathBar, sapsystemPathBar).Return(sapSystemMapBar, nil)
	sapsystemPathBuzz := "trento/v0/hosts/buzz/sapsystems/"
	consulInst.On("WaitLock", sapsystemPathBuzz).Return(nil)
	kv.On("ListMap", sapsystemPathBuzz, sapsystemPathBuzz).Return(sapSystemMapBuzz, nil)
