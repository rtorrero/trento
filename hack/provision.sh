...
if [ $# -lt 7 ]; then
  echo "Usage: ./setup.sh <github-user> <github-repo> <actions-runner-token> <actions-runner-name> <consul-bind-ip> <consul-server-ip> [agent|web]"
  exit 1
fi
...
CONSUL_HCL_TEMPLATE_URL="https://raw.githubusercontent.com/trento_project/trento/main/hack/$CONSUL_HCL.template"

CONSUL_SYSTEMD_UNIT="consul.service"
CONSUL_SYSTEMD_UNIT_URL="https://raw.githubusercontent.com/trento_project/trento/main/hack/$CONSUL_SYSTEMD_UNIT"

TRENTO_PATH=/srv/trento
TRENTO_SYSTEMD_UNIT="trento-$ROLE.service"
TRENTO_SYSTEMD_UNIT_URL="https://raw.githubusercontent.com/trento_project/trento/main/hack/$TRENTO_SYSTEMD_UNIT"
